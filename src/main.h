...
extern const color_t COLOR_BROWN, COLOR_DGREEN, COLOR_DRED, COLOR_PURPLE, COLOR_DBLUE, COLOR_YELLOW, COLOR_GREY, COLOR_LBROWN, COLOR_ORANGE, COLOR_LEG, COLOR_MBODY, COLOR_LLAND, COLOR_DLAND;
